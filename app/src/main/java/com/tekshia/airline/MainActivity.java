...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegistra.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                RegistrarUsuario(getUsername(),getPassword());
            }
        });
    }
    ...
    private void ValidarUsuario(final String username, String password) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(MainActivity.this, "Ocurrió en error", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    //Registrar Usuario
    private void RegistrarUsuario(final String username, String password) {
        //TODO poner URL
        String URL = "http://"+ Purchase.Url+"/WSAirline/controller/ClienteController.php?op=2" +
                "&username="+username+"&password="+password;
        //Init WS with Volley
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (estado.contains("successRegister")) {
